    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Molestias repellendus cupiditate explicabo consectetur fuga eum harum commodi sint quod aliquid quis 
            voluptates rem ab, beatae ipsam totam earum ex odio!</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <div className='flex items-center gap-2 pt-4'>
            ...
            className='border border-gray-500/30 bg-gray800 text-gray-500
