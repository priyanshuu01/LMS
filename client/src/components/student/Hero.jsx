...
const Hero = () => {
  return (
    ...
    bg-gradient-to-b from-cyan-100/70'>
      <h1 className='md:text-home-heading-large text-home-heading-small relative font-bold text-gray-800 max-w-3xl mx-auto'>Shape your future with courses tailored to your goals <span className='text-blue-600'> -your journey, your choice.</span><img src={assets.sketch} alt="sketch" 
      ...
      <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>We bring
        together world-class instructors, interactive content, and a supportive community to help you achieve your personal and professional goals. 
      </p>
