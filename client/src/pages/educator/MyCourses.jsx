      ...
      rounded-md bg-white border border-gray-500,20'>
        <table className='md:table-auto table-fixed w-full overflow-hidden'>
          <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left'>
           <tr>
            <th className='px-4 py3 font-semibold truncate'>All Courses</th>
            <th className='px-4 py3 font-semibold truncate'>Earnings</th>
            <th className='px-4 py3 font-semibold truncate'>Students</th>
            <th className='px-4 py3 font-semibold truncate'>Published On</th>
           </tr>
          </thead>
            ...
            {courses.map((course)=>(
              <tr key={course._id} className='border-b border-gray-500/20'>
                ...
                <td className='px-4 py-3'>{currency}{Math.floor(course.
                  enrolledStudents.length *(course.coursePrice - course.discount * course.coursePrice/100)
                )}</td>
