...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      bg-gradient-to-b from-cyan-100/70 pointer-events-none'></div>
        {/*left column*/}
                ...
                {courseData.courseContent.map((chapter,index)=>(
                  <div className='border border-gray-300 bg-white mb-2 rounded' key={index}>
                    <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=> toggleSection(index)}>
                      ...
                      <div className={`overflow-hidden transition-all duration-300 ${openSections[index]?'mah-h-96' :'max-h-0'}`}>
                            ...
                            <li key={i} className='flex items-start gap-2 py-1'>
                               ...
                               <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                                ...
                                <div className='flex gap-2'>
                                  ...
                                  })} className='text-blue-500'>Preview</p>}
         ...
         { playerData ?
          ...
          <div className='p-5'>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-defaut list-disc text-gray-500'>
